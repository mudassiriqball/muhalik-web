...
import vendorOutOfStockProductsPageLimit from '../../../../../vendor-out-stock-products_page_limit';
import vendorOutOfStockProductsQuerySearch from '../../../../../vendor-out-stock-products_query_search';
        ...
        switch (param) {
            ...
            default:
                return <>
                    ...
                    >
                        {!isSearch ?
                            out_stock_products_loading ?
                                <Loading />
                                :
                                out_stock_products_total > 0 ?
                                    <>
                                        <ProductTable
                                            list={out_stock_products}
                                            pageNumber={page}
                                        ...
                                        <hr />
                                        <PaginationRow
                                            totalPages={out_stck_products_pages}
                            ...
                            :
                            out_stock_products_query_loading ?
                                <Loading />
                                :
                                out_stock_products_query_total > 0 ?
                                    <>
                                        <ProductTable
                                        ...
                                        <hr />
                                        <PaginationRow
                                            totalPages={out_stck_products_query_pages}
