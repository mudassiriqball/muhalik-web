...
// export default function DeliveredOrders({ user }) {
...
//         const url = MuhalikConfig.PATH + `/api/users/avatar/${user._id}`
...
//             <label className='heading'>Delivered Orders</label>
...
//                                 </InputGroup>
//                             </Form.Group>
//                             {user.role == 'customer' && <Form.Group as={Col} className='my_profile_col'>
