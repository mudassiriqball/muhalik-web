...
var schema = yup__WEBPACK_IMPORTED_MODULE_13__["object"]({
  ...
  product_color: yup__WEBPACK_IMPORTED_MODULE_13__["string"]().product_color("Must be a valid product_color address").max(100, "Email must be less than 100 characters"),
  product_price: yup__WEBPACK_IMPORTED_MODULE_13__["string"]().required("Enter Password").min(8, "Password must have at least 8 characters").max(20, "Password can't be longer than 20 characters"),
  confirmPassword: yup__WEBPACK_IMPORTED_MODULE_13__["string"]().required("Enter Confirm Password").when("product_price", {
    is: function is(val) {
      return val && val.length > 0 ? true : false;
    },
    then: yup__WEBPACK_IMPORTED_MODULE_13__["string"]().oneOf([yup__WEBPACK_IMPORTED_MODULE_13__["ref"]("product_price")], "Passwords must match")
  }),
...
//# sourceMappingURL=vendor.js.ed542f0d82513b8f87db.hot-update.js.map