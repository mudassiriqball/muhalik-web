        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _copyArray = response.data.data;

              _copyArray.forEach(function (data, index) {
                data.label = true;
              });

              this.setState({
                categoryList: _copyArray
              });
              this.setState({
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 9:
              ...
              console.log('categorytList:', this.state.categoryList);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleEditCategoryClick$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              copyArrayy = Object.assign([], this.state.categoryList);
              copyArrayy[index].label = false;
              obj = {};
              obj['value'] = copyArrayy[index].value;
              obj['label'] = copyArrayyy[index].label;
              obj['prevVal'] = copyArray[index].value;
              copyArrayy[index] = obj;
              _context4.next = 9;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.setState({
                categoryList: copyArrayy
              }));
...
//# sourceMappingURL=admin.js.8333b6722ff187a4b980.hot-update.js.map