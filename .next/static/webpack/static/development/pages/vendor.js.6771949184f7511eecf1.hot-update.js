    ...
    value: function render() {
      ...
      return __jsx(formik__WEBPACK_IMPORTED_MODULE_12__["Formik"], {
        ...
        onSubmit: function onSubmit(values, _ref) {
          ...
          if (_this3.state.productCategories == '' || _this3.state.productSubCategories == '' || _this3.state.files == [] && values.product_type == 'simple-product') {
            ...
            if (_this3.state.files == [] && values.product_type == 'simple-product') {
              _this3.setState({
...
//# sourceMappingURL=vendor.js.6771949184f7511eecf1.hot-update.js.map