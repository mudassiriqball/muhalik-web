      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleEditCategoryRequestClick$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 9:
              console.log('preVal:', this.state.categoryRequestList);
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_12___default.a.Fragment, null, __jsx(_alert_modal__WEBPACK_IMPORTED_MODULE_16__["default"], {
        ...
        return __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_8__["Form"].Row, {
          ...
          onClick: function onClick() {
            return data.label ? _this2.handleEditCategoryClick(index) : _this2.handleUpdateCategoryClick(index);
          },
          __self: _this2,
          __source: {
            fileName: _jsxFileName,
          ...
          style: styles.submit_btn,
          onClick: function onClick() {
            return _this2.handleAddCategoryRequestClick(index);
          },
          __self: _this2,
          __source: {
            fileName: _jsxFileName,
          ...
          style: styles.submit_btn,
          onClick: function onClick() {
            data.laebl ? _this2.handleDeleteCategoryRequestClick(index) : _this2.handleCancelCategoryRequestClick(index);
          },
          __self: _this2,
          __source: {
            fileName: _jsxFileName,
...
//# sourceMappingURL=admin.js.dc1b146f4d2eabfec225.hot-update.js.map