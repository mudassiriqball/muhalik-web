...
var styles = {
  ...
  search_div: {
    margin: '0% 2%' // border: `1px solid ${GlobalStyleSheet.primry_color}`,
  ...
  prepend: {
    ...
    border: "1px solid ".concat(_styleSheet__WEBPACK_IMPORTED_MODULE_2__["default"].primry_color),
    color: 'black',
    padding: '0px 25px',
    display: 'flex',
    textAlign: 'center',
...
//# sourceMappingURL=index.js.66c2e47b3d7ecbefe7f6.hot-update.js.map