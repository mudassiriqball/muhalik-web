...
var ProducFields = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ProducFields, [{
    ...
    value: function componentDidMount() {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function componentDidMount$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              Object(_babel_runtime_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_8__["default"])("token");
            ...
            case 3:
              token = _context.sent;
              url = _sdk_muhalik_config__WEBPACK_IMPORTED_MODULE_14__["default"].PATH + '/api/categories/fields';
              currentComponent = this;
              _context.next = 8;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_16___default.a.get(url, {
                headers: {
                  'authorization': token
                }
    ...
    value: function addField(fieldValue, currentComponent) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function addField$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              url = _sdk_muhalik_config__WEBPACK_IMPORTED_MODULE_14__["default"].PATH + '/api/categories/field';
              data = [];
              data = {
                label: fieldValue,
                value: fieldValue
              ...
              _context2.next = 5;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_16___default.a.post(url, {
                data: data
              }, {
                headers: {
                  'authorization': token
    ...
    value: function handleAddFieldRequestClick(index) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleAddFieldRequestClick$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              url = _sdk_muhalik_config__WEBPACK_IMPORTED_MODULE_14__["default"].PATH + '/api/categories/field';
              ...
              currentComponent = this;
              data = [];
              data = Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])({
                value: copyArray[index].value
              }, "value", copyArray[index].value);
              _context4.next = 8;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_16___default.a.post(url, {
    ...
    value: function handleDeleteFieldRequestClick() {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleDeleteFieldRequestClick$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              currentComponent = this;
              copyArray = Object.assign([], this.state.fieldRequestList);
              url = _sdk_muhalik_config__WEBPACK_IMPORTED_MODULE_14__["default"].PATH + "/api/categories/field-request/".concat(copyArray[index]._id);
              _context5.next = 8;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_16___default.a["delete"](url, {
                headers: {
                  'authorization': token
                }
              }).then(function (response) {
    ...
    value: function handleEditFieldClick(index) {
      var copyArray, obj;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleEditFieldClick$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              copyArray = [];
    ...
    value: function handleUpdateFieldClick() {
      var copyArray, currentComponent, data, url;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleUpdateFieldClick$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              copyArray = [];
            ...
            case 7:
              ...
              url = _sdk_muhalik_config__WEBPACK_IMPORTED_MODULE_14__["default"].PATH + "/api/categories/field/".concat(copyArray[index]._id);
              _context7.next = 13;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_16___default.a.put(url, {
                data: data
              }, {
                headers: {
                  'authorization': token
    ...
    value: function handleDeleteFieldClick() {
      var index, copyArray, currentComponent, url;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleDeleteFieldClick$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              index = this.state.delete_field_index;
    ...
    value: function render() {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_13___default.a.Fragment, null, __jsx(_alert_modal__WEBPACK_IMPORTED_MODULE_17__["default"], {
      ...
      }, this.state.error))), __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["Form"].Group, {
        __self: this,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 362,
      ...
      }, this.state.isLoading ? 'Uploading' : 'Add Field', this.state.isLoading ? __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["Spinner"], {
        animation: "grow",
        size: "sm",
        __self: this,
        __source: {
        ...
        return __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["Form"].Row, {
          key: index,
          __self: _this2,
          __source: {
            fileName: _jsxFileName,
        ...
        }, element.label ? 'Edit' : 'Update'))), __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["Form"].Group, {
          as: react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["Col"],
          lg: "auto",
          md: "auto",
          sm: "auto",
...
//# sourceMappingURL=admin.js.17516e603d874f3be1de.hot-update.js.map