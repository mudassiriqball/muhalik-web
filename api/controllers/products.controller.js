...
//   console.log('Fuck you', req.query.q)
// }
...
productsController.get_products = async (req, res) => {
  ...
  let sub_category;
  try {
    if (req.query.field === "sub_category") {
      // const category_query="Electronics"
      const sub_category_query = req.query.q

      sub_category = await Sub_Category.find({ label: sub_category_query });
      console.log("category", sub_category)
      const query = sub_category;
      console.log(query[0]._id);
      products = await Products.paginate(
        { sub_category_id: query[0]._id },
        {
          limit: 4,
          page: req.query.page,
        }
    ...
    if (req.query.field === "New") {
      var datetime = new Date();
      console.log("Today date", datetime);
      datetime.setMonth(datetime.getMonth() - 1);
      console.log("month ago", datetime);
